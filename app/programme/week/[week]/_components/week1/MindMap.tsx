...
Pallof Press · 3×10/side · 60s rest`
  ...
  return (
    <div>
      {/* Blueprint-style mind map canvas */}
      <div style={{
        ...
        {/* Canvas with grid background and absolute-positioned nodes */}
        <div style={{
          ...
          <svg viewBox="0 0 1000 460" preserveAspectRatio="none" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%' }}>
            ...
            <g stroke="#1F1B16" strokeWidth="1.4" fill="none" strokeLinecap="round" filter="url(#r-mm-wk1)" opacity="0.55">
              {/* Center → Mon */}
              ...
              {/* Center → Why */}
              <path d="M 500 230 Q 310 330, 175 370" />
              {/* Center → Sets */}
          ...
          {/* Why full body */}
          <div style={{
            position: 'absolute', left: '6%', top: '70%',
          ...
          {/* Not yet sub-node */}
          <div style={{
            position: 'absolute', left: '34%', top: '84%',
            background: 'var(--paper)', color: 'var(--ink)',
            fontFamily: 'var(--sans)', fontSize: 11, fontWeight: 500,
            padding: '5px 9px', borderRadius: 12,
            border: '1.5px solid var(--ink)',
          ...
          {/* Hand annotations */}
          <span className="mm-start-here" style={{
          ...
          <span style={{
            position: 'absolute', left: '8%', top: '58%',
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 16 }} className="flat-schedule-grid">
          {[
            {
      ...
      <style>{`
        @media (max-width: 600px) {
          ...
          /* Reposition "start here" so it sits above the Sets node without overlapping centre */
          .mm-start-here { left: 4% !important; top: 4% !important; font-size: 14px !important; transform: rotate(-2deg) !important; }
        }
      `}</style>
    </div>
  )
